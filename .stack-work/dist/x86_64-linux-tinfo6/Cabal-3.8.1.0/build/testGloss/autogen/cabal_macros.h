...
/* package Cobraskell-0.1.0.0 */
#ifndef VERSION_Cobraskell
#define VERSION_Cobraskell "0.1.0.0"
#endif /* VERSION_Cobraskell */
#ifndef MIN_VERSION_Cobraskell
#define MIN_VERSION_Cobraskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Cobraskell */
...
#define CURRENT_COMPONENT_ID "Cobraskell-0.1.0.0-9qfWQcJxliR9OopaZRg0r5-testGloss"
